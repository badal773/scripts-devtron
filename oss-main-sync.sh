...
git_sensor=quay.io/devtron/test:7e887911-536-21089
...
dashboard=quay.io/devtron/dashboard:65860b6e-537-21142
devtron=quay.io/devtron/devtron:58418d0f-534-21141
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:58418d0f-534-21141
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:65860b6e-537-21142
