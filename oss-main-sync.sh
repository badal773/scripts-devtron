...
dashboard=quay.io/devtron/dashboard:6172db0e-537-19819
devtron=quay.io/devtron/devtron:00d86387-534-19838
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:00d86387-534-19838
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:6172db0e-537-19819
