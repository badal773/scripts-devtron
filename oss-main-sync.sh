...
dashboard=quay.io/devtron/dashboard:9a84a845-537-21477
...
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:9a84a845-537-21477
