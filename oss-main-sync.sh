...
git_sensor=quay.io/devtron/test:bd235ac9-536-20657
...
devtron=quay.io/devtron/devtron:c3987b80-534-20660
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:c3987b80-534-20660
