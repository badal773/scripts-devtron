...
dashboard=quay.io/devtron/dashboard:aabb39a8-537-20340
devtron=quay.io/devtron/devtron:0f5e22c2-534-20336
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:0f5e22c2-534-20336
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:aabb39a8-537-20340
