...
dashboard=quay.io/devtron/dashboard:302a8b63-537-19711
devtron=quay.io/devtron/devtron:eefded8f-534-19713
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:eefded8f-534-19713
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:302a8b63-537-19711
