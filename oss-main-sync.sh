...
dashboard=quay.io/devtron/dashboard:86e9a2e0-537-20122
devtron=quay.io/devtron/devtron:f999691e-534-20121
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:f999691e-534-20121
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:86e9a2e0-537-20122
