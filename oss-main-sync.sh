...
git_sensor=quay.io/devtron/test:c6b909da-536-21195
...
dashboard=quay.io/devtron/dashboard:872affd6-537-21346
devtron=quay.io/devtron/devtron:1b1713bc-534-21211
image_scanner=quay.io/devtron/image-scanner:1e0b2312-559-21160
ci_runner=quay.io/devtron/ci-runner:84554651-541-21117
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:1b1713bc-534-21211
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:872affd6-537-21346
