...
kubewatch=quay.io/devtron/kubewatch:4c6ee2d8-539-19435
lens=quay.io/devtron/lens:3d6e488a-540-19044
dashboard=quay.io/devtron/dashboard:c0b851d4-537-19529
devtron=quay.io/devtron/devtron:eae2e3f0-534-19546
image_scanner=quay.io/devtron/image-scanner:2c3eb6f6-559-19333
ci_runner=quay.io/devtron/ci-runner:30c9c3f0-541-19538
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:eae2e3f0-534-19546
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:c0b851d4-537-19529

kubectl set image deploy/kubewatch -n devtroncd kubewatch=quay.io/devtron/kubewatch:4c6ee2d8-539-19435
