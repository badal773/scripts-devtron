...
git_sensor=quay.io/devtron/test:3eb0ac77-536-20300
...
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:e77fdf11-537-20285
