...
dashboard=quay.io/devtron/dashboard:3beee989-537-20102
...
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:3beee989-537-20102
