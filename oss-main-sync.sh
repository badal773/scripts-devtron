...
dashboard=quay.io/devtron/dashboard:9a25d30d-537-19752
devtron=quay.io/devtron/devtron:bb575b50-534-19759
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:bb575b50-534-19759
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:9a25d30d-537-19752
