...
dashboard=quay.io/devtron/dashboard:954ee883-537-20224
...
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:954ee883-537-20224
