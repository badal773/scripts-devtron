...
dashboard=quay.io/devtron/dashboard:77f78b60-537-20444
devtron=quay.io/devtron/devtron:aa6e9be9-534-20443
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:aa6e9be9-534-20443
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:77f78b60-537-20444
