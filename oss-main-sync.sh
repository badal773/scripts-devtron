...
dashboard=quay.io/devtron/dashboard:2327bac1-537-20880
devtron=quay.io/devtron/devtron:88328c23-534-20871
image_scanner=quay.io/devtron/image-scanner:28f95d21-559-20762
ci_runner=quay.io/devtron/ci-runner:d4dadb96-541-20829
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:88328c23-534-20871
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:2327bac1-537-20880
