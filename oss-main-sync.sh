...
dashboard=quay.io/devtron/dashboard:3ec9f221-537-20448
...
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:3ec9f221-537-20448
