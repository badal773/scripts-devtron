...
dashboard=quay.io/devtron/dashboard:be5ce8eb-537-20126
devtron=quay.io/devtron/devtron:1f040a2f-534-20151
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:1f040a2f-534-20151
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:be5ce8eb-537-20126
