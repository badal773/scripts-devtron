...
kubewatch=quay.io/devtron/kubewatch:425397b4-539-19956
lens=quay.io/devtron/lens:a0628f4f-540-19938
dashboard=quay.io/devtron/dashboard:bd24067e-537-20011
devtron=quay.io/devtron/devtron:4fd3b138-534-20010
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:4fd3b138-534-20010
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:bd24067e-537-20011

kubectl set image deploy/kubewatch -n devtroncd kubewatch=quay.io/devtron/kubewatch:425397b4-539-19956
