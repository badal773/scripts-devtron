...
dashboard=quay.io/devtron/dashboard:5835f4a2-537-19790
devtron=quay.io/devtron/devtron:baa5765b-534-19770
...
kubectl set image deploy/devtron -n devtroncd devtron=quay.io/devtron/devtron:baa5765b-534-19770
kubectl set image deploy/dashboard -n devtroncd dashboard=quay.io/devtron/dashboard:5835f4a2-537-19790
